...
// FIX: Define the STOP macro properly so it maps to 0x9C40200C
#define IOCTL_STOP_CAPTURE CTL_CODE(SEC_AI_DEVICE_TYPE, 0x803, METHOD_BUFFERED, FILE_ANY_ACCESS)
